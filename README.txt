Introduction
============
JavaCV first provides wrappers to commonly used libraries by researchers in the field of computer vision: OpenCV, ARToolKitPlus, libdc1394 2.x, and PGR FlyCapture. Moreover, utility classes make it easy to use their functionality on the Java platform. JavaCV also comes with hardware accelerated fullscreen image display (CanvasFrame), easy-to-use methods to execute code in parallel on multiple cores (Parallel), user-friendly geometric calibration of cameras and projectors (GeometricCalibrator, ProCamGeometricCalibrator), adaptive binarization (JavaCV.adaptiveBinarization()), and code to detect and match features points (ObjectFinder).
...
- ARToolKitPlus 2.1.1c  http://www.ok.ctrl.titech.ac.jp/~saudet/procamcalib/#download
...
And feel free to contact me if you have any questions or find any problems with the software! I am sure it is far from perfect...
